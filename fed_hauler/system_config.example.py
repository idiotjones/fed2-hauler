...
shell_commodity_sources = {
		...
		'Nickel': [pl.all_planets['helicon'], pl.all_planets['doubtful'], pl.all_planets['crash'], pl.all_planets['welch']],
		...
		'Simulations': [pl.all_planets['cinna'], pl.all_planets['wreck'], pl.all_planets['welch'], pl.all_planets['poveglia']],
		'Soya': [],
		'Spices': [],
