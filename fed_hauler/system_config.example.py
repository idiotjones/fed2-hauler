...
shell_commodity_sources = {
		...
		'BioChips': [pl.all_planets['crash']],
		'BioComponents': [pl.all_planets['doubtful'], pl.all_planets['crash']],
		'Cereals': [],
		'Clays': [pl.all_planets['doubtful'], pl.all_planets['bilk'], pl.all_planets['welch'], pl.all_planets['divide']],
		...
		'Fruit': [pl.all_planets['bilk'], pl.all_planets['herringbone'], pl.all_planets['fisticuffs'], pl.all_planets['zaldrizes']], # pl.all_planets['new street glide']],
		'Furs': [],
		...
		'Hides': [pl.all_planets['herringbone'], pl.all_planets['fisticuffs'], pl.all_planets['bilk'], pl.all_planets['implausible']],
		...
		'Laboratories': [pl.all_planets['crash'], pl.all_planets['newsgroup']],
		...
		'Libraries': [pl.all_planets['unlikely'], pl.all_planets['crash']],
		'Livestock': [],
		'LubOils': [pl.all_planets['doubtful'], pl.all_planets['crash']],
		'Meats': [pl.all_planets['implausible'], pl.all_planets['divide'], pl.all_planets['bilk'], pl.all_planets['fisticuffs']],
		...
		'Nickel': [pl.all_planets['doubtful'], pl.all_planets['crash'], pl.all_planets['welch']],
		'Nitros': [pl.all_planets['improbable'], pl.all_planets['wreck'], pl.all_planets['crash']],
		'Petrochemicals': [pl.all_planets['crash']],
		'Pharmaceuticals': [pl.all_planets['doubtful'], pl.all_planets['crash']],
		'Polymers': [pl.all_planets['crash']],
		...
		'Proteins': [pl.all_planets['poveglia'], pl.all_planets['kittygarden'], pl.all_planets['gervais']],
		...
		'Semiconductors': [pl.all_planets['doubtful'], pl.all_planets['fisticuffs'], pl.all_planets['implausible'], pl.all_planets['welch'], pl.all_planets['divide']],
		...
		'Sensors': [pl.all_planets['doubtful'], pl.all_planets['newsgroup']],
		'Simulations': [pl.all_planets['wreck'], pl.all_planets['welch'], pl.all_planets['poveglia']],
		'Soya': [],
		'Spices': [],
		'Studios': [pl.all_planets['doubtful'], pl.all_planets['unlikely'], pl.all_planets['wreck']],
		'Synths': [pl.all_planets['doubtful']],
		'Textiles': [pl.all_planets['implausible'], pl.all_planets['bilk'], pl.all_planets['divide'], pl.all_planets['fisticuffs'], pl.all_planets['email']],
