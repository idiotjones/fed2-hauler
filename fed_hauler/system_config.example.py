...
'Crystals': [pl.all_planets['doubtful']],
...
'Generators': [pl.all_planets['unlikely']],
...
'Radioactives': [pl.all_planets['doubtful'], pl.all_planets['valisk']], # , pl.all_planets['new street glide']
...
'Xmetals': [pl.all_planets['demolish']], # , pl.all_planets['doubtful'] 
}
